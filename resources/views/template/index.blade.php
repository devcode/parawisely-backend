    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="{{ $title == "Ulasan" ? "active" : "" }}">
                    <a href="{{ url('/showComment') }}"><i class="fas fa-comment-dots"></i>
                        <span class="side-link">Ulasan</span></a>
                </li>
            </ul>
            @endif
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    ...
                                    <img class="img-profile rounded-circle"
                                        src="{{ asset('backend/uploads/'.$dataAuth->image) }}">
                                    {{ $dataAuth->name }}
                                </a>
        ...
        <div class="modal fade bd-example-modal-xl" tabindex="-1" id="contact_modal" role="dialog"
